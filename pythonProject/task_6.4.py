...
class PoliceCar(Car):
    ...
    def police_car(self):
        if self.is_police:
            return f"This is a property of police department."
        else:
            return f"This is not a property of police department."
...
while True:
    ...
    if user_input.lower() == "x":
        ...
        print(town.turn(direction=None))
        print(town.stop())
        ...
        print(sport.turn(direction=None))
        print(sport.stop())
        ...
        print(work.turn(direction=None))
        print(work.stop())

    elif user_input.lower() == "police":
        police = PoliceCar(input("Car brand: ").capitalize(), input("Car color: "), int(input("Car speed: ")), True)
        print(police.police_car())
        print(police.go())
        print(police.show_speed())
        print(police.turn(direction=None))
        print(police.stop())
